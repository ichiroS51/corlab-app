    ...
    <div class="container flex flex-col justify-center p-6 mx-auto">
        <section class="flex items-center h-full sm:p-16 dark:bg-gray-900 dark:text-gray-100">
            <div
                ...
                <p class="text-3xl">Parece que no tienes acceso a internet!</p>
                <!-- <router-link :to="{ name: 'Landing' }" rel="noopener noreferrer" href="#"
                    class="px-8 py-3 font-semibold rounded dark:bg-violet-400 dark:text-gray-900">Regresar</router-link> -->
            </div>
        </section>
    </div>
</template>
